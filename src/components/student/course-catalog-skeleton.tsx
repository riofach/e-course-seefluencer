...
export function CourseCatalogSkeleton() {
  return (
    <div className="space-y-8">
      <div className="rounded-[32px] border border-[#2A2A3C] bg-[#14141C] px-6 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
          ...
          <div className="rounded-[28px] border border-[#2A2A3C] bg-[#1A1A24] p-6">
      ...
      <Skeleton className="h-14 w-full max-w-3xl rounded-3xl bg-[#1A1A24]" />

      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }, (_, index) => (
          <Card
            key={index}
            className="overflow-hidden rounded-3xl border border-[#2A2A3C] bg-[#1A1A24]"
          >
            <div className="h-52 border-b border-[#2A2A3C] p-4">
